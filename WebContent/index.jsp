...
<fieldset>
  ...
  <%-- Use the .../show-balance address that is set in web.xml instead of
       the invoker servlet address of .../servlet/coreservlets.ShowBalance --%>
...
<fieldset>
  ...
  <form action="./prime"> <%-- Address from web.xml  --%>
